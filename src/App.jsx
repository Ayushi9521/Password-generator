...
const [charAllowed, setCharlAllowed] = useState(false);
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500'>
      ...
      <div className='flex shadow round-lg overflow-hidden mb-4'>
        <input type="text" onClick={copyPassword} value={Password} className='outline-none w-full py-1 px-3' placeholder={Password} readOnly  ref={PasswordRef}/>
